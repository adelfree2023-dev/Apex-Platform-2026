...
describe('AdminController', () => {
    ...
    describe('getPlatformStats', () => {
        ...
        it('should handle errors', async () => {
            mockAdminService.getPlatformStats.mockRejectedValue(new Error('Database error'));
    ...
    describe('getTenants', () => {
        it('should return all tenants', async () => {
            ...
            mockAdminService.getTenants.mockResolvedValue(tenants);
        ...
        it('should handle errors', async () => {
            mockAdminService.getTenants.mockRejectedValue(new Error('Database error'));
    ...
    describe('getTenant', () => {
        it('should return tenant by ID', async () => {
            ...
            mockAdminService.getTenant.mockResolvedValue(tenant);
        ...
        it('should throw 404 for non-existent tenant', async () => {
            mockAdminService.getTenant.mockResolvedValue(null);
    ...
    describe('getTenantStats', () => {
        it('should return tenant statistics', async () => {
            ...
            mockAdminService.getTenantStats.mockResolvedValue(stats);
        ...
        it('should handle errors', async () => {
            mockAdminService.getTenantStats.mockRejectedValue(new Error('Error'));
    ...
    describe('getRecentOrders', () => {
        it('should return recent orders for tenant', async () => {
            ...
            mockAdminService.getRecentOrders.mockResolvedValue(orders);
        ...
        it('should return empty array for tenant with no orders', async () => {
            mockAdminService.getRecentOrders.mockResolvedValue([]);
    ...
    describe('getTopProducts', () => {
        it('should return top products for tenant', async () => {
            ...
            mockAdminService.getTopProducts.mockResolvedValue(products);
    ...
    describe('updateTenant', () => {
        it('should update tenant successfully', async () => {
            ...
            mockAdminService.updateTenant.mockResolvedValue(updatedTenant);
        ...
        it('should handle errors', async () => {
            mockAdminService.updateTenant.mockRejectedValue(new Error('Error'));
    ...
    describe('Edge Cases', () => {
        it('should handle empty stats', async () => {
            mockAdminService.getPlatformStats.mockResolvedValue({
                totalTenants: 0,
                activeTenants: 0,
                totalOrders: 0,
                totalRevenue: 0,
